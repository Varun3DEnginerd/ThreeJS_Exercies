...
void main()
{
    ...
    vec3 reflectionColor = textureCube(uReflectionMap, reflectedDir).rgb;
    

    vec3 tintedReflection = mix(reflectionColor, reflectionColor * uBloodColor * 2.0, 0.3);
    vec3 reflection = tintedReflection * fresnel * uReflectionStrength;
